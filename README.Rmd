...
the intended context—transparently to the user.
...
Validating an object (say, a data frame) is nothing more than applying an
...
## Related packages
  ...
  * valaddin provides a basic set of predicate functions—prefixed `vld_*()` for
    ...
    scalar?, does it have the expected type?, etc.).
    
    Use specialized collections of predicate functions to enrich valaddin’s
    vocabulary:
